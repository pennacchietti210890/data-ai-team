...
def create_data_scientist():
    ...
    return Agent(
        ...
        instructions=(
            ...
            "2. The SQL query must include **both input features and the target variable** (based on the user’s modeling goal).\n"
            ...
            "   - The full input data (JSON string of the DataFrame)\n"
